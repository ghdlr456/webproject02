...
<html>
	...
	<body>
		<div class="container">
		<form class="form-horizantal" role="form" method="post"   enctype="multipart/form-data" action="/board/createPost">
			...
			<div class="col-xs-10 col-lg-10">
				<input type="file" class="form-control" name="uploadFile" size="20">
			</div>
			</div>
